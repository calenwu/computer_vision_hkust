...
void ImpressionistUI::cb_alphalides(Fl_Widget* o, void* v)
{
	float temp = float(((Fl_Slider*)o)->value());
	((ImpressionistUI*)(o->user_data()))->m_nAlpha = temp;
}
void ImpressionistUI::cb_brushDirectionChoice(Fl_Widget* o, void* v)
{
	...
	((ImpressionistUI*)(o->user_data()))->m_nBrushDirection = type;
}
...
void ImpressionistUI::setAngle(int angle)
{
	...
	if (m_nAngle <= 359 && m_nAngle >= 0)
		...
		// ((ImpressionistUI*)(m_BrushAngleSlider->user_data()))->m_nBrushDirection = m_nAngle;
}
...
//-------------------------------------------------
void ImpressionistUI::setThickness(int angle)
{
	m_nThickness = angle;

	if (m_nThickness <= 1 && m_nThickness >= 0)
...
{
	return ((ImpressionistUI*)(m_BrushAlphaSlider->user_data()))->m_nAlpha;
}
...
//------------------------------------------------
// Return the brush direction
//------------------------------------------------
int ImpressionistUI::getBrushDirection()
{
...
// Set the brush alpha
//-------------------------------------------------
void ImpressionistUI::setBrushDirection(int brushDirection)
{
	m_nBrushDirection = brushDirection;

	if (m_nBrushDirection <= 3 && m_nBrushDirection >= 0)
		m_BrushDirectionChoice->value(m_nBrushDirection);
}
...
// Brush choice menu definition
Fl_Menu_Item ImpressionistUI::brushDirectionMenu[4 + 1] = {
  {"Slider",			FL_ALT + '1', (Fl_Callback*)ImpressionistUI::cb_brushDirectionChoice, (void*)SLIDER},
  {"Right_click",		FL_ALT + '2', (Fl_Callback*)ImpressionistUI::cb_brushDirectionChoice, (void*)RIGHT_CLICK},
  {"Gradient",			FL_ALT + '3', (Fl_Callback*)ImpressionistUI::cb_brushDirectionChoice, (void*)GRADIENT},
  {"Brush direction",	FL_ALT + '4', (Fl_Callback*)ImpressionistUI::cb_brushDirectionChoice, (void*)BRUSH_DIRECTION},
  {0}
};
...
ImpressionistUI::ImpressionistUI() {
	...
	m_brushDialog = new Fl_Window(400, 325, "Brush Dialog");
		...
		m_BrushThicknessSlider->maximum(20);
		...
		// Add the brush direction choice option
		m_BrushDirectionChoice = new Fl_Choice(110, 160, 150, 25, "&Brush Direction");
		...
		m_BrushAngleSlider = new Fl_Value_Slider(10, 190, 300, 20, "Angle");
		...
		m_BrushAlphaSlider = new Fl_Value_Slider(10, 230, 300, 20, "Alpha");
		...
		m_BrushAlphaSlider->callback(cb_alphalides);
    m_brushDialog->end();	
